...
const file_user_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"user.proto\x12\x06userpb\x1a\x1cgoogle/api/annotations.proto\"=\n" +
	...
	"\vUserService\x12Y\n" +
	"\n" +
	"CreateUser\x12\x19.userpb.CreateUserRequest\x1a\x1a.userpb.CreateUserResponse\"\x14\x82\xd3\xe4\x93\x02\x0e:\x01*\"\t/v1/users\x12R\n" +
	"\aGetUser\x12\x16.userpb.GetUserRequest\x1a\x17.userpb.GetUserResponse\"\x16\x82\xd3\xe4\x93\x02\x10\x12\x0e/v1/users/{id}B\x0eZ\fproto/userpbb\x06proto3"
...
var file_user_proto_depIdxs = []int32{
	...
	2, // 1: userpb.UserService.GetUser:input_type -> userpb.GetUserRequest
	1, // 2: userpb.UserService.CreateUser:output_type -> userpb.CreateUserResponse
	3, // 3: userpb.UserService.GetUser:output_type -> userpb.GetUserResponse
